...
#splitting
ALLOW_TRACK_SPLITTING = True	#was true... do I want to allow splitting or not?? Doesn't currently work with XY-extractor
...
#### Save XML file
## need to fix string passing bug first (I think this is fixed by using raw strings)
## savename is argument passed from initiating macro
#savename = savename.replace('\a','\\a')
#savename = savename.replace('\b','\\b')
#savename = savename.replace('\f','\\f')
#savename = savename.replace('\n','\\n')
#savename = savename.replace('\r','\\r')
#savename = savename.replace('\t','\\t')
#savename = savename.replace('\v','\\v')

#savename = savename.replace('\1','\\1')
#savename = savename.replace('\2','\\2')
#savename = savename.replace('\3','\\3')
#savename = savename.replace('\4','\\4')
#savename = savename.replace('\5','\\5')
#savename = savename.replace('\6','\\6')
#savename = savename.replace('\7','\\7')


## business end of XML saving
